...
Let’s map the landscape for B2B SaaS Customer Success leaders most concerned with operationalizing AI for onboarding in the first 90 days.
...
- **Ops resources are lean:** Mid-market teams with <20 CSMs, no dedicated CS ops admin, and a bias for self-service.
...
| **Ops/Admin Capacity**      | Dedicated admin(s)  | <1 FTE shared ops     | None/minimal   |
| **Onboarding Volume**      | 50+/month           | 5–100/month           | <10/month      |
